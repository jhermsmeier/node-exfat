...
File.prototype = {
  ...
  parse: function( buffer ) {
    ...
    this.times = {
      created: Time.toUnix( this.crdate, this.crtime, this.crtimeCs ),
      modified: Time.toUnix( this.mdate, this.mtime, this.mtimeCs ),
      accessed: Time.toUnix( this.adate, this.atime, this.atimeCs || 0 ),
    }
