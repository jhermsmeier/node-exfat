...
class File extends ExFAT.DirEntry {
  ...
  constructor() {
    ...
    this.mtimeCs = 0x00
    /** @type {Number} Creation time UTC offset */
    this.createUtcOffset = 0x00
    /** @type {Number} Modification time UTC offset */
    this.lastModifiedUtcOffset = 0x00
    /** @type {Number} Access time UTC offset */
    this.lastAccessedUtcOffset = 0x00
    /** @type {Number} Unknown2 */
    this.unknown2 = Buffer.alloc( 7 )
  ...
  static read( instance, buffer, offset ) {
    ...
    instance.createUtcOffset = buffer.readUInt8( offset + 22 )
    instance.lastModifiedUtcOffset = buffer.readUInt8( offset + 23 )
    instance.lastAccessedUtcOffset = buffer.readUInt8( offset + 24 )
    
    buffer.copy( instance.unknown2, 0, offset + 25, offset + 32 )
  ...
  static write( instance, buffer, offset ) {
    ...
    offset = buffer.writeUInt8( instance.createUtcOffset, offset )
    offset = buffer.writeUInt8( instance.lastModifiedUtcOffset, offset )
    offset = buffer.writeUInt8( instance.lastAccessedUtcOffset, offset )
